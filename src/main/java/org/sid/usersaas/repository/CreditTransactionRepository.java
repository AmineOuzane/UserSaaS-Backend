...
public interface CreditTransactionRepository extends JpaRepository<CreditTransaction, Long> {
    ...
    List<CreditTransaction> findByAppUserAndTransactionDateAfterAndTransactionType(AppUser appUser, LocalDateTime startDate, TransactionSource transactionSource);

    List<CreditTransaction> findByAppUser(AppUser appUser);
}
